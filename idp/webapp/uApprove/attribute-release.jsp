...
<form method="post" style="padding:10px">
    ...
    <div class="box">
            ...
            <% if (localizedServiceInformationURL != null && !localizedServiceInformationURL.equals("") ) { %>
            <p style="margin-top: 10px;">
            <a href="<%= localizedServiceInformationURL %>"><fmt:message key="serviceInformationURLText"/></a>
            </p>
            <% } %>
            ...
            <% if (localizedServicePrivacyStatementURL != null && !localizedServicePrivacyStatementURL.equals("") ) { %>
            <a href="<%= localizedServicePrivacyStatementURL %>"><fmt:message key="servicePrivacyStatementURLText"/></a>
            <% } %>
